...
const translations = {
    en: {
        ...
        f1_desc: 'Any small thing can be easily placed into the right time block',
        f2_label: 'Quick access',
        f2_title: 'Every item leads you to the next step',
        f2_desc: 'Links, locations, files, and text – all easily captured and organized into readable content, ready to open anytime.',
        f3_label: 'Keep it simple',
        f3_title: 'Everything for today, all on one page',
        f3_desc: 'Your day in one place, clear to see, and adapts as things change',
        uc1_title: 'Work follow-ups',
        uc1_desc: 'Keep handoffs, follow-ups, and post-meeting tasks in one place – instead of scattered in notes, chats, and to-dos.',
        uc2_title: 'Between classes and homework',
        uc2_desc: 'Things to submit, materials to read, messages to reply, tasks for later... no need for exact times, just drop them into the right period.',
        uc3_title: 'For days that keep changing',
        uc3_desc: 'Groceries, trips, city walks, or busy multi-tasking days – things move easily and plans stay clear.',
    ...
    ja: {
        ...
        label: '日本語',
        nav_cta: '無料で始める',
        hero_title: 'ものごとに<br>まず居場所を',
        hero_sub: '小さなことがメモやリマインダー、ToDoリストに埋もれないように',
        hero_cta: '無料で始める',
        f1_label: '時間帯で整理する',
        f1_title: 'カレンダーに詰め込まなくていい、もう忘れる心配もいりません',
        f1_desc: 'どんな小さなことでも、適切な時間帯にさっと置くだけ',
        f2_label: 'クイックアクセス',
        f2_title: 'すべての項目が、次の一歩へつながる',
        f2_desc: 'リンク、場所、ファイル、テキスト。すべてを簡単に取り込み、読みやすく整理。いつでもすぐに開けます。',
        f3_label: 'シンプルに保つ',
        f3_title: '今日一日のすべてを、一ページに',
        f3_desc: '一日の流れを一箇所で。見やすく、予定の変更にもしなやかに対応。',
        uc1_title: '仕事のフォローアップ',
        uc1_desc: '引き継ぎやフォローアップ、会議後のタスクを一箇所にまとめます。メモやチャット、ToDoリストに散らばることはありません。',
        uc2_title: '放課後や課題の合間に',
        uc2_desc: '提出物、資料の読み込み、返信、後でやるタスク...正確な時間を決めずに、適切な時間枠に入れるだけ。',
        uc3_title: '変わり続ける一日に',
        uc3_desc: '買い物、旅行、街歩き、あるいは忙しく流動的な一日でも、予定を簡単に動かせて流れが見えやすくなります。',
        quote: '“煩雑なタスクリストと固定された時間に縛られない毎日を”',
        quote_attr: 'InToday のフィロソフィー',
        cta_title: '今日から、ものごとに居場所を！',
        cta_btn: '無料で始める',
