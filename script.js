...
const translations = {
    en: {
        ...
        faq_a1: 'IntoDay is a minimal day-planning application designed to bring intention and clarity to your daily routine, without the overwhelming clutter of traditional project management tools.',
        faq_q2: 'How is this different from a calendar?',
        faq_a2: 'While calendars track hard appointments, IntoDay focuses on the rhythm of your tasks and intentions. It\'s about how you want to feel and what you want to focus on, not just where you need to be.',
        faq_q3: 'Do I need to set exact times?',
        faq_a3: 'Not at all. We encourage time-blocking by broader phases of the day (morning, afternoon, evening) to allow for flexibility and flow, rather than rigid minute-by-minute scheduling.',
        faq_q4: 'Can I move things later?',
        faq_a4: 'Yes. Life happens. You can easily drag and drop items to the next day or a future backlog without feeling penalized by the system.',
    ...
    zh: {
        ...
        faq_title: '常见问题',
        faq_q1: '什么是 IntoDay？',
        faq_a1: 'IntoDay 是一款极简的日程规划应用，旨在为您的日常生活带来目标感和清晰度，而不会像传统的项目管理工具那样杂乱。',
        faq_q2: '这与日历有何不同？',
        faq_a2: '日历追踪固定预约，而 IntoDay 专注于任务和意图的节奏。它关注您的感受和关注点，而不仅仅是您需要去哪里。',
        faq_q3: '我需要设定精确的时间吗？',
        faq_a3: '完全不需要。我们鼓励按一天的不同阶段（早晨、下午、晚上）进行时间块规划，以允许灵活性和流动性，而不是僵化的分钟制调度。',
        faq_q4: '我可以稍后再处理吗？',
        faq_a4: '是的。生活中总有意外。您可以轻松地将项目拖放到第二天或未来的待办列表中，而不会感到被系统“惩罚”。',
        help_contact_label: '仍需协助？',
    },
    ms: {
        flag: '🇲🇾',
        label: 'MY',
